            ...
            const expected = [
                {
                    ...
                    table: [
                        ...
                        { label: '20:00', class: 'bg-slate-400' },
                        { label: '21:00', class: 'bg-slate-500' },
                        { label: '22:00', class: 'bg-slate-600' },
                        { label: '23:00', class: 'bg-slate-700' },
                    ]
                },
            ]
            ...
            const expected = [
                {
                    ...
                    table: [
                        ...
                        { label: '20:30', class: 'bg-slate-400' },
                        { label: '21:30', class: 'bg-slate-500' },
                        { label: '22:30', class: 'bg-slate-600' },
                        { label: '23:30', class: 'bg-slate-700' },
            ...
            const expected = [
                {
                    ...
                    table: [
                        ...
                        { label: '20:45', class: 'bg-slate-400' },
                        { label: '21:45', class: 'bg-slate-500' },
                        { label: '22:45', class: 'bg-slate-600' },
                        { label: '23:45', class: 'bg-slate-700' },
