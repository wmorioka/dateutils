<script setup>
defineProps(['isTwoMonthsModeEnabled'])
</script>

<template>
    <div class="absolute right-0">
        <div class="flex items-center">
            <button type="button" class="mr-3" title="Show previous" @click="$emit('move', 'prev')">
            ...
            <button type="button" class="mr-5" title="Show next" @click="$emit('move', 'next')">
                <svg class="fill-gray-500 w-7 h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
